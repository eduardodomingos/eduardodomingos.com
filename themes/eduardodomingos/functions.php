...
function eduardodomingos_setup() {
	...
	add_theme_support( 'custom-background', apply_filters( 'eduardodomingos_custom_background_args', array(
		'default-color' => 'ffffff',
		'default-image' => '',
	) ) );
}
endif; // eduardodomingos_setup
...
function eduardodomingos_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'eduardodomingos_content_width', 640 );
}
...
function eduardodomingos_scripts() {
	wp_enqueue_style( 'eduardodomingos-style', get_stylesheet_uri() );

	wp_enqueue_script( 'eduardodomingos-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'eduardodomingos-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
