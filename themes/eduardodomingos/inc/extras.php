...
function eduardodomingos_share_buttons( $label = 'Share', $url = '', $title = '', $description = '', $classes = '' ) {
    ...
    $html .= '<a title="'. esc_html__( 'Share on', 'eduardodomingos' ) .' Twitter" href="https://twitter.com/intent/tweet?original_referer=' . $url . '&text=' . $title . ': ' . $url . '&via=eddomingos" class="link-share-twitter"><span class="icon--twitter"></span></a>';
