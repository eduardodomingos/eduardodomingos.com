...
if ( ! function_exists( 'eduardodomingos_scripts' ) ) :
    function eduardodomingos_scripts() {
        ...
        wp_enqueue_style( 'main_css', get_template_directory_uri() . '/assets/build/css/main.css' );

        // Scripts
        wp_enqueue_script( 'main_js', get_template_directory_uri() . '/assets/build/js/main.js', array( 'jquery', 'underscore' ), '', true );
    }
endif;
